    ...
    if (clear.texture_rect == surface.GetScaledRect()) {
        scheduler.Record([params, clear](vk::CommandBuffer cmdbuf) {
            ...
            const vk::ImageMemoryBarrier pre_barrier = {
                ...
                .oldLayout = PreferredSteadyStateLayout(type, params.aspect, traits.usage, is_storage,
                                                      is_framebuffer),
            ...
            const vk::ImageMemoryBarrier post_barrier = {
                ...
                .newLayout = PreferredSteadyStateLayout(type, params.aspect, traits.usage, is_storage,
                                                      is_framebuffer),
                .srcQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
                .dstQueueFamilyIndex = VK_QUEUE_FAMILY_IGNORED,
                .image = params.src_image,
