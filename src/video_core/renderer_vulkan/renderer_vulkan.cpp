...
[[nodiscard]] bool IsPresentTraceEnabled() {
    // v115-D-MUX rollback: make the measurement robust even if an old emulators.cfg entry still
...
void main() {
    ...
    if (IsStrictCompatEnabled()) {
        LOG_WARNING(Render_Vulkan,
                    "TRACE_DRAW strict_compat v115d_mux renderer_draw_command_mux_marker force_quiet_present={} force_quiet_display={} shader_module_probe={} pipeline_bind_probe={} first_vkcmd_draw_probe={} first_vkcmd_draw_zero_count_probe={} first_vkcmd_draw_zero_count_real_vertex_bind_ultra_quiet_probe={} d_a_draw0={} d_b_draw3={} d_c_draw6={} d_d_drawindexed0={} d_e_drawindexed3={} pica_accel_draw_command_mux_v115d_expected=1",
                    ...
                    static_cast<u32>(IsEnvEnabledLocal("BORKED3DS_V3DV_PROBE_V115_D_B_REAL_VERTEX_BIND_DRAWCMD_3")),
