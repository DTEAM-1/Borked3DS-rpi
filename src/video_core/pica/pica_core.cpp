...
void PicaCore::DrawArrays(bool is_indexed) {
    ...
    if (is_textured_startup_draw) {
        ...
        if (textured_startup_index <= 6) {
            if (trace_draw) {
                LOG_INFO(HW_GPU,
                         "TRACE_DRAW_PICA strict_compat forcing software fallback for textured startup draw draw_index={} textured_startup_index={} indexed={} num_vertices={} primitive_empty={} textures_disabled={} textured_startup_window=3",
