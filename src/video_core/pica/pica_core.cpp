...
void PicaCore::DrawArrays(bool is_indexed) {
    ...
    if (first_nonindexed96_textured_startup_candidate) {
        ...
        constexpr u64 nonindexed96_textured_startup_skip_window = 192;
        if (nonindexed96_textured_startup_skip_index <= nonindexed96_textured_startup_skip_window) {
            if (trace_draw) {
                LOG_INFO(HW_GPU,
                         "TRACE_DRAW_PICA strict_compat skipping nonindexed96 textured startup draw entirely v17 draw_index={} nonindexed96_textured_startup_skip_index={} indexed={} num_vertices={} primitive_empty={} textures_disabled={} topology={} color_addr=0x{:08X} depth_addr=0x{:08X} skip_window={}",
                ...
                LogPicaTextureState(regs.internal, "nonindexed96_textured_startup_skip_v17");
            }
            return;
        }
        ...
        if (trace_draw &&
            ...
            LOG_INFO(HW_GPU,
                     "TRACE_DRAW_PICA strict_compat allowing nonindexed96 textured startup draw acceleration after v17 skip window draw_index={} indexed={} num_vertices={} topology={} color_addr=0x{:08X} depth_addr=0x{:08X}",
                     draw_index, is_indexed, regs.internal.pipeline.num_vertices,
                     static_cast<u32>(primitive_assembler.GetTopology()),
                     regs.internal.framebuffer.framebuffer.GetColorBufferPhysicalAddress(),
                     regs.internal.framebuffer.framebuffer.GetDepthBufferPhysicalAddress());
            LogPicaTextureState(regs.internal, "nonindexed96_textured_startup_allow_v17");
        }
    }
    ...
    if (first_nonindexed36_textured_startup_candidate) {
        ...
        constexpr u64 nonindexed36_textured_startup_skip_window = 256;
        if (nonindexed36_textured_startup_skip_index <= nonindexed36_textured_startup_skip_window) {
            if (trace_draw) {
                LOG_INFO(HW_GPU,
                         "TRACE_DRAW_PICA strict_compat skipping nonindexed36 textured startup draw entirely v17 draw_index={} nonindexed36_textured_startup_skip_index={} indexed={} num_vertices={} primitive_empty={} textures_disabled={} topology={} color_addr=0x{:08X} depth_addr=0x{:08X} skip_window={} tex0_format={}",
                ...
                LogPicaTextureState(regs.internal, "nonindexed36_textured_startup_skip_v17");
            }
            return;
        }
        ...
        if (trace_draw &&
            ...
            LOG_INFO(HW_GPU,
                     "TRACE_DRAW_PICA strict_compat allowing nonindexed36 textured startup draw acceleration after v17 skip window draw_index={} indexed={} num_vertices={} topology={} color_addr=0x{:08X} depth_addr=0x{:08X} tex0_format={}",
                     draw_index, is_indexed, regs.internal.pipeline.num_vertices,
                     static_cast<u32>(primitive_assembler.GetTopology()),
                     regs.internal.framebuffer.framebuffer.GetColorBufferPhysicalAddress(),
                     regs.internal.framebuffer.framebuffer.GetDepthBufferPhysicalAddress(),
                     static_cast<u32>(primary_textures[0].format));
            LogPicaTextureState(regs.internal, "nonindexed36_textured_startup_allow_v17");
        }
    }
